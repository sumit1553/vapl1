...
import { Download, LayoutGrid, Link, Mail, Share } from "lucide-react";
...
// function  QrCodeGenerator(id:any) {
...
function  QrCodeGenerator(props: {
  ...
  console.log('extra',logoFile, qrType, setEmail, setSubject, setMessage, email, subject, message);

  // const affiliate =  getAffilateById(id);
// console.log('affiliate-check', affiliate)
  // const generated = false

  // const handleGenerate = () => {
  //   // console.log('share QR')
    
  //   const path = 'http://localhost:3001' + '/' + id.id
  ...
  // console.log('affiliate', affiliate);
      ...
      // const path = PUBLIC_URL + '/' + id.id
      const path = PUBLIC_URL + '/ally/' + props.id
        ...
        <CardContent className="flex-1">
          <div className="h-full flex flex-col md:flex-row gap-8">
            <div className="flex-1 space-y-6">
              ...
              >
                <TabsList className="h-10 w-full grid grid-cols-2 bg-[#057FFF] text-lg">
                    ...
                    <TabsTrigger value="whatsapp" className="text-white font-bold">
              ...
              <div className="space-y-4 border tp-5 m-5">
                <Separator />
            ...
            <div className="relative flex-1 bg-[#037FFF] rounded-lg flex flex-col justify-center space-y-6">
              ...
              <div className="flex  justify-center ">{'Aff name'}</div>
