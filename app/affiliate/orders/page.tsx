...
import { getAffilaiteOrdersbyID } from '@/lib/actions/order.actions2';

export const metadata: Metadata = {
  title: 'Affiliate Orders',
};

const AffilateOrdersPage = async (props: {
  ...
  const orders = await getAffilaiteOrdersbyID({
    page: Number(page),
    // query: searchText,
    affid:affid,
  });
...
export default AffilateOrdersPage;
