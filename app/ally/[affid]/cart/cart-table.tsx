...
const CartTable = ({ cart , affid}: { cart?: Cart; affid: string; }) => {


  // console.log('affid-cart', affid)
    ...
    <>
      ...
      {!cart || cart.items.length === 0 ? (
        <div>
          ...
          Cart is empty. <Link href={`/ally/${affid}`}>Go Shopping</Link>
        </div>
      ) : (
            ...
            <CardContent className='p-4 gap-4'>
              ...
              <Button
                ...
                onClick={() =>
                  ...
                  startTransition(() => router.push(`/ally/${affid}/shipping-address`))
                }
              >
                {isPending ? (
                  <Loader className='w-4 h-4 animate-spin' />
